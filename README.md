...
# Запуск проекта
Создайте файл .env в той же директории, где лежит env_example

Перенесите содержимое env_example в .env

Из директории, в которой находится файл docker-compose.yaml, выполните следующие команды:
```
